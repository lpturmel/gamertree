...
const Settings: FunctionComponent<SettingsProps> = () => {
	...
	return (
		<Layout>
			...
			{ profile.isLoading ? <Spinner /> : <div className="vstack container mx-auto max-w-sm space-y-4 pt-8">
				<div className="vstack space-y-2">
					...
					<div className="relative">
                        ...
                        {userAvailability.isLoading ? <Spinner  /> : 
                        userAvailability.isError ? <CgClose className="w-8 h-8 text-red-500" /> : 
                        userAvailability.data && <CgCheck className="w-8 h-8 text-green-500" />}
                        </div>
					</div>
